  ...
  return (
    <div className="bg-transparent h-700px w-full flex flex-col z-10 overflow-auto scroll-bar">
      <div className="w-full h-fit bg-black/[.55]">
        ...
        <div className="w-full min-h-[1200px] h-fit bg-[#65482C]/[.5] flex flex-row relative overflow-hidden">
          {/* Background Video */}
          <video
            autoPlay
            loop
          ...
          <div className="bg-transparent w-full h-full flex flex-col items-center px-10 md:px-20 relative z-20">
            <div className="flex-col flex w-full items-center justify-center gap-1 mb-8 mt-32">
              <h1 className="text-[#FFE4CC] md:text-[35px] text-[22px] font-merriweatherBold opacity-0 animate-slideUpFadeIn" style={{ animationDelay: "0.2s" }}>SJ HANDICRAFTS</h1>
            ...
            <PartnersCarousel showTitle={true} animationDelay="0.8s" />
          </div>
